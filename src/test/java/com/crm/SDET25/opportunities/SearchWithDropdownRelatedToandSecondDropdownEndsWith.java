...
public class SearchWithDropdownRelatedToandSecondDropdownEndsWith {
	@Test
	public void searchWithDropdownRelatedToandSecondDropdownEndsWith() throws Throwable {
		...
		wdUtil.selectVisible(dropDown2, "contains");
		driver.findElement(By.xpath("//b[text()='Advanced Search']/following::input[@class='crmbutton small create']")).click();
