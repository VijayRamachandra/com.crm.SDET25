...
public class SearchWithDropdownRelatedToandSecondDropdownNotEqualTo {
	
	@Test
	public void searchWithDropdownRelatedToandSecondDropdownNotEqualTo() throws Throwable {
		...
		wdUtil.selectVisible(dropDown2, "starts with");
		driver.findElement(By.xpath("//b[text()='Advanced Search']/following::input[@class='crmbutton small create']")).click();
	}
