...
public class SearchWithDropdownRelatedToandSecondDropdownStartWith {

	@Test
	public void searchWithDropdownRelatedToandSecondDropdownStartWith() throws Throwable {
		...
		wdUtil.selectVisible(dropDown2, "ends with");
		driver.findElement(By.xpath("//b[text()='Advanced Search']/following::input[@class='crmbutton small create']")).click();
	}
