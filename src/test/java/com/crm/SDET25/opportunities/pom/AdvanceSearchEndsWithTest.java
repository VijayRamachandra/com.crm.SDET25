...
public class AdvanceSearchEndsWithTest extends BaseClass{
	...
	public void searchWithDropdownRelatedToandSecondDropdownEndsWithTest() throws Throwable {
		...
		String endsWith = fUtil.readDataFromPropertyFile("dropDown2Option3");
		sPage.fillNoneTextField(endsWith);
