...
import com.crm.SDET25.genericUtility.IpathConstants;
...
public class AdvanceSearchContainsTest extends BaseClass{
	...
	public void searchWithDropdownRelatedToandSecondDropdownContainsTest() throws Throwable {
		...
		/*Create New Contact*/
		String LASTNAME = exUtil.getDataFromExcelSheet(IpathConstants.SHEET_NAME, 14, 2)+ jUtil.getRamdomNumber();
		...
		String contains = exUtil.getDataFromExcelSheet("Sheet1", 14, 3);
		sPage.fillNoneTextField(contains);

		sPage.fillSearchTextField(LASTNAME);
