...
public class AdvanceSearchDoesNotContainsTest extends BaseClass{
	...
	public void searchWithDropdownRelatedToandSecondDropdownDoesNotContainsTest() throws Throwable {
		...
		String doesNotContains = fUtil.readDataFromPropertyFile("dropDown2Option2");
		sPage.fillNoneTextField(doesNotContains);
