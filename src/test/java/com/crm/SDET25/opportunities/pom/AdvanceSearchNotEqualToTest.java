...
public class AdvanceSearchNotEqualToTest extends BaseClass{
	...
	public void searchWithDropdownRelatedToandSecondDropdownNotEqualToTest() throws Throwable {
		...
		String notEqualTo = fUtil.readDataFromPropertyFile("dropDown2Option5");
		sPage.fillNoneTextField(notEqualTo);
